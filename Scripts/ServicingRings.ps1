...
Set-AzStorageBlobContent -Container $outputContainerName -File ServicingOutput.csv -Blob ServicingOutput.csv -Force

#Add snapshot file with timestamp
$date = Get-Date -format "dd-MMM-yyyy_HH:mm"
$timeStampFileName = "ServicingOutput_" + $date + ".csv"
Set-AzStorageBlobContent -Container $snapshotsContainerName -File ServicingOutput.csv -Blob $timeStampFileName -Force
